...
<%@page import="com.banking.tcs.service.CustomerService"%>
...
<body class="text-justify">
  <nav class="navbar navbar-light navbar-expand-md bg-dark" style="height: 130px;margin: auto;">
    ...
    <h2 class="mt-3 text-center">Customer Status</h2>
              ...
              <%
              		...
              		if(customers != null){
	                   ...
	                   for(int i=0; i<customers.size(); i++){
	                   	...
	                   	%> 
	                   	<tr>
	               <td><%= customers.get(i).getSsn() %></td>
	               <td><%= customers.get(i).getSsn() %></td>
	               <td><%= customers.get(i).getStatus() %></td>
	               <td><%= customers.get(i).getMsg() %></td>
	               <td>2016-02-24 15:59:51</td>
