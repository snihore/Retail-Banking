...
<body class="text-justify">
    ...
    <h2 class="mt-3 text-center">Account Status</h2>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
             <!--  <tr>
                ...
                <td>Savings</td>
                <td>Pending</td>
                <td>Customer already has account of specific type</td>
                <td>2016-02-24 15:59:51</td>
              ...
              <%
              	...
              	if(accounts != null){
              		...
              		for(int i=0; i<accounts.size(); i++){
              			...
              			String type = accounts.get(i).getAccountType();
			              ...
			              <tr>
			                <td><%= accounts.get(i).getCustomerID() %></td>
			                <td><%= accounts.get(i).getAccountNum() %></td>
			                <td><%= type %></td>
			                <td><%= accounts.get(i).getAccountStatus() %></td>
			                <td><%= accounts.get(i).getAccountMsg() %></td>
			                <td><%= accounts.get(i).getLastUpdatedDate() %></td>
			                <td><a href="">Refresh</a></td>
			              </tr>
    ...
    <h1>Loop through the contents of database with help of jsp</h1>
</div>
