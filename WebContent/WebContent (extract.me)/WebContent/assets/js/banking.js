...
function create_customer(){
	var customerId = document.getElementById("ssnid");
	var customerName = document.getElementById("name");
	var customerAdd = document.getElementById("address");
	var customerAge = document.getElementById("age");
	var letters = /^[A-Za-z ]+$/;
	var idVal = /^[0-9]+$/;
	//alert(customerId.value.length)
	if(customerId.value.length!=9){
		alert("Customer Id should be of 9 digits");
		return false;
	}
	if(customerId.value.match(idVal))
    {
    ...
    if(customerName.value.match(letters) || customerName.length<101)
    {
	...
	if(customerAge.value>200 || customerAge.value<0)
	{
		alert("Invalid Age");
		return false;
	}
	if(customerAdd.value.length>250){
		alert("Address limit is 250 !");
		return false;
	}
	return true;
...
function update_customer(){
	//var customerId = document.getElementById("ssnid");
	var customerName = document.getElementById("new_cus_name");
	var customerAdd = document.getElementById("new_address");
	var customerAge = document.getElementById("new_age");
	var letters = /^[A-Za-z ]+$/;
    if(customerName.value.match(letters) || customerName.length<101)
    {
...
function search_customer(){
	var ssn = document.getElementById("ssnid");
	var id = document.getElementById("custid");

	if(ssn.value.length==0 && id.value.length==0){
		
			alert("Please provide either SSN or Customer ID");
			return false;
		
	}

	else if(ssn.value.length==0 && id.value.length==9){
		return true;
	}
	...
	else if(ssn.value.length==9 && id.value.length==0){
		return true;
	}
		...
		alert("Invalid SSN or Customer ID");
		return false;
	}
...
function create_account(){
	var id = document.getElementById("acc_ssnid");
	var type = document.getElementById("acc_type");
	var amount = document.getElementById("acc_amount");
	var idVal = /^[0-9]+$/;
	if(id.value.length!=9){
		alert("Customer Id should be of 9 digits");
		return false;
	}
	if(id.value.match(idVal))
    {
...
function account_details(){
	var ssn = document.getElementById("accnid");
	var id = document.getElementById("custid");

	if(ssn.value.length==0 && id.value.length==0){
		
			alert("Please provide either Account ID or Customer ID");
			return false;
		...
		alert("Invalid Account ID or Customer ID !");
		return false;
	}
...
function deposit_money(){
	var num = document.getElementById("damount").value; 
	var Val = /^[0-9]+$/;
	if (isNaN(num)) 
	{
	    alert("Invalid Amount !");
...
function withdraw_money(){
	...
	var num = document.getElementById("wamount").value; 
	var Val = /^[0-9]+$/;
	if (isNaN(num)) 
	{
	    alert("Invalid Amount !");
...
function transfer_money(){
	var num = document.getElementById("Tamount").value; 
	var type1 = document.getElementById("saccount").value;
	var type2 = document.getElementById("Taccount").value;
	var Val = /^[0-9]+$/;
...
function account_statement(){
	var type1 = document.getElementById("acc_id").value;
	var radio1 = document.getElementById("last_trn");
	var radio2 = document.getElementById("str_end_date");
	var type = document.getElementById("no_of_tr");
	var Val = /^[0-9]+$/;
	if (isNaN(type1)) 
	{
	    alert("Invalid Account ID !");
	...
	var checkRadio = radio1.checked || radio2.checked;
	...
	if(radio1.checked==true){
		...
		{
			alert("Please Specify The Number of Transactions !");
			return false;
		}
	}
	return true;
...
function account_statement2(){
	var date1 = document.getElementById("startdate").value;
	var date2 = document.getElementById("lastdate").value;
