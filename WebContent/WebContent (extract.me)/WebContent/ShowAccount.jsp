...
<%@ include file = "header2.jsp" %>
    ...
    <div class = "text-center mt-5">
        ...
        <table class="table table-borderless">
            <tbody>
              <tr>
                <td><a href="DepositeMoney.jsp" class="btn btn-primary button_custom">Deposit Money</a></td>
                <td><a href="WithdrawMoney.jsp" class="btn btn-primary button_custom">Withdraw Money</a></td>
                <td><a href="TransferMoney.jsp" class="btn btn-primary button_custom">Transfer Money</a></td>
